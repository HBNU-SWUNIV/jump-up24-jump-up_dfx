...
def recognize_structure_script(img):
    # print(img.shape)
...
original_img = cv2.imread("./partially.jpg")
# finalboxes, output_img = recognize_structure_colab(original_img)
finalboxes, output_img = recognize_structure_script(original_img)
# denoising(original_img)
